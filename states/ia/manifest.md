...
State: Iowa
Requirement: 36 CE hours per 3-year license term
...
The full L-version catalog totals approximately 37 hrs, which meets the 36-hr requirement. All available content is included — nothing is dropped.
...
**IMPORTANT: Iowa requires a proctored exam for all self-study credit. All self-study final exams must be administered under approved proctoring (online or in-person). Platform must support proctoring integration before IA launch.**
...
| GEN.INS-CE-LHPRD | Self-Study (proctored) | 9.50 |
| GEN.INS-CE-PCCOM | Self-Study (proctored) | 8.50 |
| **Classroom Equiv Total** | | **19.50 hrs** |
| **Self-Study Total** | | **18.00 hrs** |
| **Grand Total** | | **37.50 hrs** (meets 36-hr requirement; ~1.5 hr buffer) |

## IA Build Work Summary

| Item | Count |
|---|---|
| Quiz checkpoints (classroom equiv) | 30 |
| Final exam questions — LHPRD (proctored) | 95 minimum |
| Final exam questions — PCCOM (proctored) | 85 minimum |
| **Total final exam questions** | **180 minimum** |

## IA State-Specific Notes

- Iowa requires 36 CE hours per 3-year renewal period. This catalog delivers ~37.50 hrs, comfortably meeting the requirement.
- No mandatory classroom/self-study split; the classroom-equivalent structure is included for delivery quality.
- Self-study requires a proctored exam in Iowa. Platform must support approved online proctoring before IA launch — this is a hard regulatory requirement.
- No carryover of excess CE hours is permitted in Iowa.
- Annuity training: 1x 4-hour course required — not covered by this catalog; must be sourced separately or built as a standalone course.
...
- Indexed life insurance training: 1x 4-hour course required for producers selling indexed life products — not covered by this catalog; must be sourced separately.
- Both online classroom equivalent and online self-study are recognized by the Iowa Insurance Division.
