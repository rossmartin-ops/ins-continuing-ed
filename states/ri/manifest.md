...
Note: Rhode Island does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Rhode Island.
...
- **Line of authority minimum:** Producers must complete a minimum of 5 CE hours per line of authority held per term
