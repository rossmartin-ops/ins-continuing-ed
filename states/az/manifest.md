...
State: Arizona
Requirement: 48 CE hours per 4-year license term
- No mandatory classroom/self-study split
- Ethics/consumer protection: minimum 6 hours (double the standard — full ETH course covers 2.70 hrs; additional ethics content needed)
- No proctored exam requirement noted for self-study

Hours calculated using standard formula: words ÷ 180 ÷ 50 = credit hours

## ⚠️ COVERAGE GAP — PARTIAL FULFILLMENT ONLY

The full L-version content catalog totals approximately 37.50 hrs. Arizona requires 48 hrs per 4-year term. **This catalog covers ~37.50 of the required 48 hours — an ~10.50-hr gap.** This manifest includes all available content; nothing is dropped.

Additionally, Arizona requires 6 hours of ethics CE. The ETH course provides 2.70 hrs. **An additional ~3.30 hrs of ethics content must be built or sourced separately.**

| Requirement | Required | Covered by This Catalog | Gap |
|---|---|---|---|
| Total CE hours | 48 hrs | ~37.50 hrs | ~10.50 hrs must come from other sources |
| Ethics hours | 6 hrs | 2.70 hrs (ETH course) | ~3.30 hrs additional ethics content needed |

---

## Classroom Equivalent Courses (19.50 hrs)
...
**2.70 hrs | All levels and chapters included | Partial credit toward 6-hr ethics requirement**
...
Note: L1 Ch1 has a placeholder welcome page that needs to be personalized before launch. Arizona requires 6 ethics hours; this course provides 2.70 hrs. A supplemental ethics course of at least 3.30 hrs must be built or sourced separately.

---

### GEN.INS-CE-LHOPT — Life & Health Insurance Options (full catalog)
...
### GEN.INS-CE-PCPER — Understanding Personal Lines Property & Casualty Insurance (full catalog)
**8.20 hrs | All 6 levels | All 13 chapters included**
...
| | Ch3 | Yes | 0.30 | Children and Coverage |
...
| L5: Fair Claims Practices | Ch1 | Yes | 0.69 | Unfair Claims Settlement Practices, Timeliness Requirements |
| L6: Insuring Valuables and Collectibles | Ch1 | Yes | 0.83 | Scheduled Personal Property, Floaters, Blanket Coverage |
| | Ch2 | Yes | 0.49 | Collectibles, Jewelry, Fine Art Valuation |
| **Total** | | | **8.20** | |

---

## Self-Study Courses (18.00 hrs)

Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score.

### GEN.INS-CE-LHPRD — Life & Health Products and Compliance (full catalog)
**9.50 hrs | All 6 levels | All 11 chapters included | Final exam: 95 questions minimum**

| Level | Chapter | Include | Hrs | Exam Qs | Topics |
|---|---|---|---|---|---|
| L1: Insurance Regulation | Ch1 | Yes | 0.43 | 4 | State Insurance Regulation, Licensing Requirements |
| | Ch2 | Yes | 0.64 | 6 | Market Conduct, Unfair Trade Practices |
...
| | Ch3 | Yes | 0.32 | 3 | Security Safeguards, Administrative, Physical, Technical |
| **Total** | | | **9.50** | **95** | |

---

### GEN.INS-CE-PCCOM — Understanding Commercial Property & Casualty Insurance (full catalog)
**8.50 hrs | All 8 levels | All 17 chapters included | Final exam: 85 questions minimum**
...
| L7: Errors and Omissions Insurance | Ch1 | Yes | 0.37 | 4 | E&O Basics, Coverage Triggers, Claims-Made |
| | Ch2 | Yes | 0.43 | 4 | E&O Policy Structure, Exclusions, Risk Management |
| L8: Employment Practices Liability | Ch1 | Yes | 0.39 | 4 | EPLI Coverage, Wrongful Acts, Defense |
| | Ch2 | Yes | 0.46 | 5 | EPLI Exclusions, Claims Handling, Policy Limits |
| **Total** | | | **8.50** | **85** | |
...
| GEN.INS-CE-PCPER | Classroom Equiv | 8.20 |
| GEN.INS-CE-LHPRD | Self-Study | 9.50 |
| GEN.INS-CE-PCCOM | Self-Study | 8.50 |
| **Classroom Equiv Total** | | **19.50 hrs** |
| **Self-Study Total** | | **18.00 hrs** |
| **Grand Total (this catalog)** | | **37.50 hrs** |
| **AZ Requirement** | | **48 hrs** |
| **Gap** | | **~10.50 hrs must come from other sources** |

## AZ Build Work Summary

| Item | Count |
|---|---|
| Quiz checkpoints (classroom equiv) | 30 |
| Final exam questions — LHPRD | 95 minimum |
| Final exam questions — PCCOM | 85 minimum |
| **Total final exam questions** | **180 minimum** |

## ⚠️ MISSING CONTENT — BLOCKED

The following gaps prevent full AZ compliance with this catalog alone:

| Gap | Hours Needed | Status |
|---|---|---|
| Total CE shortfall | ~10.50 hrs | Must be sourced from other providers or new courses built |
| Additional ethics content (beyond ETH course) | ~3.30 hrs | New ethics course or ethics module must be built or sourced |

Priority topics to build to close the gap:
- Arizona-specific insurance law and regulation (~3 hrs)
- Supplemental ethics / professional responsibility (~3–4 hrs, tagged ethics credit)
- Cyber liability / emerging risks (~2–3 hrs)
- Surplus lines / specialty markets (~2 hrs)

## AZ State-Specific Notes

- Arizona requires 48 CE hours per 4-year renewal period (one of the longest cycles in the US). This catalog covers ~37.50 hrs — an ~10.50-hr gap remains.
- Ethics requirement is 6 hours — double the standard. The ETH course provides 2.70 hrs. An additional ~3.30 hrs of approved ethics content must be built or sourced before AZ launch.
- No mandatory classroom/self-study split; all hours may be self-study.
- No carryover of excess CE hours is permitted in Arizona.
- Long-tenured residents: Arizona may exempt certain long-tenured licensees from CE requirements; confirm details with AZ DOI before launch.
- No proctored exam required for self-study delivery (confirm with AZ DOI if this changes).
- Both online classroom equivalent and online self-study are recognized by the Arizona Department of Insurance.
