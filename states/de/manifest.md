...
Note: Delaware does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Delaware.
...
## DE State-Specific Notes

- **Renewal cycle:** 2-year term
- **Total CE required:** 24 hours
- **Ethics requirement:** 3 hours (satisfied by GEN.INS-CE-ETH at 2.70 hrs); note that carried-over hours may NOT include ethics hours
- **Classroom/self-study split:** No split mandated; TX baseline split used as recommended configuration
- **Flood (homeowners / personal lines producers):** 2-hour flood CE course required (not covered by this content set; must be added separately for applicable producers)
- **LTC training:** 3-hour ongoing LTC course required per renewal term for producers selling LTC (not covered by this content set; must be added separately)
- **Annuity:** 1× 4-hour annuity course required (not covered by this content set; must be added separately)
- **Hour carryover:** Up to 5 hours may be carried over into the next 2-year term; ethics hours may NOT be carried over
