...
Note: New Hampshire does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in New Hampshire.
...
- **CE deadline:** CE must be completed 60 days before license expiration date (plan accordingly; do not wait until the end of the term)
- **Flood:** 1× 3-hour NFIP flood course required (not covered by this content set; must be added separately)
- **Annuity:** 1× 4-hour annuity course required (not covered by this content set; must be added separately)
- **LTC training:** 8-hour initial + 4-hour ongoing per term (not covered by this content set; must be added separately)
