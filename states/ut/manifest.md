...
- Classroom equivalent: minimum 12 hours
...
## UT State-Specific Notes

- Content selection is identical to TX (23.87 hrs meets the 24-hr requirement).
- Both online classroom equivalent and online self-study are recognized by the Utah Insurance Department.
- Insurer-sponsored courses: Utah does not allow insurer-sponsored CE courses to count for more than 12 hours in a renewal period. This catalog is provider-neutral and should not be affected, but verify sponsor classification before filing.
- No carryover of excess CE hours is permitted in Utah.
- Annuity training: 1x 4-hour course required (once, not recurring) — not covered by this catalog; must be sourced separately or built as a standalone course.
