...
- Interactive/classroom equivalent: minimum 12 hours
...
| **Classroom Equiv Total** | | **13.10 hrs** (min 12 required) |
| **Self-Study Total** | | **10.77 hrs** (max 12 allowed) |
| **Grand Total** | | **23.87 hrs** |

## NC Build Work Summary
...
## NC State-Specific Notes

- Content selection is identical to TX (23.87 hrs meets the 24-hr requirement).
- Both online interactive/classroom equivalent and online self-study are recognized by the NC DOI.
- CE is due 60 days before license expiration — the platform and marketing communications should surface this deadline clearly. Producers who complete CE in the final 60 days before expiration may still receive credit but should be warned about timing risk.
- Flood insurance: 3-hour course required for P&C licensees the first time; after initial completion, required once every 4 years — not covered by this catalog; must be sourced separately.
- No carryover information specified; verify with NC DOI before launch.
