...
State: Virginia
Requirement: 24 CE hours per 2-year license term (dual line; single-line producers need only 16 hrs — see notes)
...
| | Ch4 | **No — drop chapter** | 0.32 | CLASS Act, LTC Partnership Programs (outdated/niche) |
...
| **Grand Total** | | **23.87 hrs** (meets 24-hr dual-line requirement) |

## VA Build Work Summary

| Item | Count |
|---|---|
| Quiz checkpoints (classroom equiv) | 20 |
| Final exam questions (self-study) | 108 minimum |

## VA State-Specific Notes

- This manifest is built for dual-line producers (24-hr requirement). Single-line producers in Virginia only need 16 hours — they may select any 16 hours from the courses above; the platform should offer a 16-hr track or note this on the product page.
- Virginia has no mandatory classroom/self-study split; the classroom-equivalent structure mirrors TX for consistency and quality, but VA does not require it.
- Content selection is identical to TX (23.87 hrs ≈ 24 hrs, acceptable under VA rounding).
- Carryover of excess CE hours is permitted in Virginia; confirm the carry-forward limit with VA SCC Bureau of Insurance before launch.
- Credit reporting fee: Virginia charges a $2.60 per credit hour reporting fee at the time credits are reported to the state. Operators should account for this fee in pricing or pass-through arrangements.
