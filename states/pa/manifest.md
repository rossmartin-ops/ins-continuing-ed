...
Note: Pennsylvania does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Pennsylvania.
...
- **Flood (P&C / Personal Lines producers):** 2-hour flood CE course required; phased in — effective April 29, 2026. Must be added as a standalone course for applicable producers (not covered by this content set)
- **Annuity:** 1× 4-hour annuity course required (not covered by this content set; must be added separately)
- **Hour carryover:** Up to 24 hours (100% of requirement) may be carried over into the next 2-year term
