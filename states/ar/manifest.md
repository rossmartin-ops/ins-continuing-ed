...
> **PROCTORED EXAM REQUIRED:** Arkansas requires a proctored final exam for all self-study (online) CE courses. Self-study course completion must be validated by a state-approved proctored exam. Build and delivery must accommodate proctored exam administration for GEN.INS-CE-LHPRD and GEN.INS-CE-PCCOM.
...
Note: Arkansas does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
> **PROCTORED EXAM REQUIRED for self-study courses in Arkansas.** Both GEN.INS-CE-LHPRD and GEN.INS-CE-PCCOM final exams must be administered under approved proctoring. Confirm proctoring vendor and workflow before launch.
...
- **PROCTORED EXAM:** Self-study (online) CE courses require a state-approved proctored final exam. Both self-study courses in this manifest must be administered with approved proctoring. Confirm proctoring vendor, platform integration, and AR-specific approval workflow before launch
- **Annuity:** 1× 4-hour annuity course required for producers selling annuities (not covered by this content set; must be added separately)
- **LTC training:** 8-hour initial + 4-hour ongoing per term required for producers selling LTC (not covered by this content set; must be added separately)
- **Hour carryover:** Up to 24 hours (100% of the requirement) may be carried over into the next 2-year term
