...
Note: Tennessee does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration. Tennessee caps seminar (live/classroom) hours at 50% of the total requirement (12 hrs); online classroom-equivalent courses are not subject to this cap.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Tennessee.
...
- **Seminar cap:** Live/in-person seminar hours are capped at 50% of the total requirement (12 hrs maximum from live seminars); this cap does not apply to online courses delivered as classroom equivalent
...
- **Hour carryover:** Up to 12 hours may be carried over into the next 2-year term
