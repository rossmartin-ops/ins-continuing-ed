...
## NJ State-Specific Notes

- Content selection is identical to TX (23.87 hrs meets the 24-hr requirement).
- Up to 12 hours of excess CE may be carried over to the next 2-year renewal period.
- Annuity training: 1x 4-hour course required (must be completed once; not a recurring renewal requirement) — not covered by this catalog; must be sourced separately or built as a standalone course.
- LTC training: 8-hour initial + 4-hour renewal requirement — not covered by this catalog; must be sourced separately or flagged for producers.
- Flood insurance: 1x 3-hour course required for P&C licensees — not covered by this catalog; must be sourced separately.
- Both online classroom equivalent and online self-study are recognized by the NJ DOI.
