...
Note: Maryland does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Maryland.
...
- **Flood (P&C producers selling flood, homeowners, or commercial property):** 2-hour flood CE course required (not covered by this content set; must be added separately for applicable producers)
- **Multi-licensed producers:** Minimum 6 CE hours required per line of authority held per term
- **LTC training:** 2-hour ongoing LTC course required per renewal term for producers selling LTC (not covered by this content set; must be added separately)
