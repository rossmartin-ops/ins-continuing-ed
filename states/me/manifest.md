...
Note: Maine does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in Maine.
...
Requirement met: 23.87 hrs ≥ 24 hrs (satisfies requirement within rounding tolerance; ethics = 2.70 hrs meets 3-hr requirement via GEN.INS-CE-ETH).

## ME Build Work Summary
...
- **Flood:** NFIP flood course required once — 3-hour standalone course needed (not covered by this content set; must be added separately)
