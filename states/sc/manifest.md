...
- Proctored exam for self-study: Not required
...
Note: South Carolina does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
Delivery requirements: final exam only (no forced progression, no checkpoints). 10 questions per credit hour, 70% passing score. No proctored exam required in South Carolina.

### GEN.INS-CE-LHPRD — Life & Health Products and Compliance
**5.41 hrs | 3 of 6 levels | 7 of 11 chapters | Final exam: 54 questions minimum**
...
**5.36 hrs | 4 of 8 levels | 11 of 17 chapters | Final exam: 54 questions minimum**
...
## SC Build Work Summary

| Item | Count |
|---|---|
| Quiz checkpoints (classroom equiv chapters) | 20 |
| Quiz checkpoint questions | 200 (10 per chapter) |
| Final exam questions — GEN.INS-CE-LHPRD | 54 minimum (ceil 5.41 × 10) |
| Final exam questions — GEN.INS-CE-PCCOM | 54 minimum (ceil 5.36 × 10) |
| **Total final exam questions** | **108 minimum** |

---

## SC State-Specific Notes

- **Renewal cycle:** 2-year term
- **Total CE required:** 24 hours
- **Ethics requirement:** 3 hours — required as standalone (satisfied by GEN.INS-CE-ETH at 2.70 hrs)
- **Classroom/self-study split:** No split mandated; TX baseline split used as recommended configuration
- **Multi-line producers:** Minimum 8 CE hours per line of authority held plus 3 ethics hours per term (e.g., a producer holding both L&H and P&C licenses needs 8 hrs L&H + 8 hrs P&C + 3 ethics = 19 hrs minimum; this content set's 23.87 hrs satisfies the single-line scenario; multi-line producers should verify total hours against their specific license holdings)
- **Annuity suitability:** Annuity suitability training required for producers selling annuities (not covered by this content set; must be added separately)
- **LTC partnership training:** LTC partnership program training required for producers selling partnership-qualified LTC policies (not covered by this content set; must be added separately)
- **Hour carryover:** Up to 18 hours may be carried over into the next 2-year term
- **Proctored exam:** Not required for self-study courses
