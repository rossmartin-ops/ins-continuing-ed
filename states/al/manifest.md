...
> **PROCTORED EXAM REQUIRED:** Alabama requires a proctored final exam for all self-study (online) CE courses. Self-study course completion must be validated by a state-approved proctored exam. Build and delivery must accommodate proctored exam administration for GEN.INS-CE-LHPRD and GEN.INS-CE-PCCOM.
...
Note: Alabama does not mandate a classroom/self-study split. The TX baseline split (13.10 hrs classroom equiv / 10.77 hrs self-study) is used as the recommended delivery configuration.
...
> **PROCTORED EXAM REQUIRED for self-study courses in Alabama.** Both GEN.INS-CE-LHPRD and GEN.INS-CE-PCCOM final exams must be administered under approved proctoring. Confirm proctoring vendor and workflow before launch.
...
- **PROCTORED EXAM:** Self-study (online) CE courses require a state-approved proctored final exam. Both self-study courses in this manifest must be administered with approved proctoring. Confirm proctoring vendor, platform integration, and AL-specific approval workflow before launch
...
- **Course repetition:** A course may not be repeated for credit within the same 2-year renewal term; each course in this manifest must be a unique offering
